...
namespace SETTING{
	...
	static LPCTSTR STR_SECTION_RESCUE_STEP = _T("Rescue%d");
	static LPCTSTR STR_SECTION_DEVICE = _T("Device");
	...
	static LPCTSTR STR_KEY_MOUSE_MODE = _T("MouseMode");
	static LPCTSTR STR_KEY_STATE_SEND_URL = _T("StateSendURL");

	static LPCTSTR STR_KEY_STEPMAX = _T("StepMax");

	static LPCTSTR STR_KEY_ERRMAX = _T("ErrorMax");

	static LPCTSTR STR_KEY_NOX = _T("Nox");
	static LPCTSTR STR_KEY_ADB = _T("ADB");
	static LPCTSTR STR_KEY_WNDHOLD = _T("WindowHold");
	static LPCTSTR STR_KEY_ACT_X = _T("ActivateX");
	static LPCTSTR STR_KEY_ACT_Y = _T("ActivateY");
	...
	static LPCTSTR STR_KEY_WNDSEARCH_R = _T("WndSearchRight");
	static LPCTSTR STR_KEY_EXE_NAME = _T("ExeName");

	static LPCTSTR STR_KEY_REBOOT = _T("Reboot");

	static LPCTSTR STR_KEY_ACCTIMEDIFF = _T("AccTimeDiff");
	...
	static LPCTSTR STR_WND_NAME_DEFAULT = _T("WndNameDefault");
